    ...
    <div>
      {(function () {
        if (allowedHospitals.length === 0) {
          return (
            <p>
              Please select a {Constants.HOSPITAL.toLowerCase()} from button
              above
            </p>
          );
          ...
          return (
            <div>
              <p>
                NOTE: You can change the {Constants.HOSPITAL.toLowerCase()}{" "}
                above
              </p>
              <p>
                Selected {Constants.HOSPITAL.toLowerCase()}:{" "}
                {selectedData.facilityName}
              </p>
              <p>Address: {address}</p>
          ...
          return (
            <p>
              Please select a single {Constants.HOSPITAL.toLowerCase()} from
              button above
            </p>
          );
        }
